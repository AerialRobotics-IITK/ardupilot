...
#define GOBJECTVARPTR(v, name, var_info_ptr)                                                                                                                   \
    {                                                                                                                                                          \
        AP_PARAM_GROUP, name, Parameters::k_param_##v, (const void*) &copter.v, {group_info_ptr: var_info_ptr},                                                \
...
const AP_Param::Info Copter::var_info[] = {
    ...
    // @Description: Defines the speed in cm/s which the aircraft will attempt to maintain horizontally while flying home. If this is set to zero, WPNAV_SPEED
    ...
    // @Description: This is the altitude the vehicle will move to as the final stage of Returning to Launch or after completing a mission.  Set to zero to
    // land.
    // @Units: cm
    // @Range: -1 1000
    // @Increment: 1
    ...
    // @Description: Controls whether failsafe will be invoked (and what action to take) when connection with Ground station is lost for at least 5 seconds. NB.
    // The GCS Failsafe is only active when RC_OVERRIDE is being used to control the vehicle.
    ...
    // @Values: 0:Disabled,1:Enabled always RTL,2:Enabled Continue with Mission in Auto Mode,3:Enabled always Land,4:Enabled always SmartRTL or RTL,5:Enabled
    // always SmartRTL or Land
    // @User: Standard
    ...
    // @Values:
    // 0:Stabilize,1:Acro,2:AltHold,3:Auto,4:Guided,5:Loiter,6:RTL,7:Circle,9:Land,11:Drift,13:Sport,14:Flip,15:AutoTune,16:PosHold,17:Brake,18:Throw,19:Avoid_ADSB,20:Guided_NoGPS,21:Smart_RTL,22:FlowHold,23:Follow
    // @User: Standard
    ...
    // @User: Advanced
    // @Values: 0:Normal Start-up, 1:Start-up in ESC Calibration mode if throttle high, 2:Start-up in ESC Calibration mode regardless of throttle, 3:Start-up
    // and automatically calibrate ESCs, 9:Disabled
    ...
    // @User: Standard
    // @Values: 0:None,1:Stab Roll/Pitch kP,4:Rate Roll/Pitch kP,5:Rate Roll/Pitch kI,21:Rate Roll/Pitch kD,3:Stab Yaw kP,6:Rate Yaw kP,26:Rate Yaw kD,56:Rate
    // Yaw Filter,55:Motor Yaw Headroom,14:AltHold kP,7:Throttle Rate kP,34:Throttle Accel kP,35:Throttle Accel kI,36:Throttle Accel kD,12:Loiter Pos
    // kP,22:Velocity XY kP,28:Velocity XY kI,10:WP Speed,25:Acro RollPitch kP,40:Acro Yaw kP,45:RC Feel,13:Heli Ext Gyro,38:Declination,39:Circle
    // Rate,41:RangeFinder Gain,46:Rate Pitch kP,47:Rate Pitch kI,48:Rate Pitch kD,49:Rate Roll kP,50:Rate Roll kI,51:Rate Roll kD,52:Rate Pitch FF,53:Rate Roll
    // FF,54:Rate Yaw FF,57:Winch
    ...
    // @Values: 0:Do Nothing, 2:Flip, 3:Simple Mode, 4:RTL, 5:Save Trim, 7:Save WP, 9:Camera Trigger, 10:RangeFinder, 11:Fence, 13:Super Simple Mode, 14:Acro
    // Trainer, 15:Sprayer, 16:Auto, 17:AutoTune, 18:Land, 19:Gripper, 21:Parachute Enable, 22:Parachute Release, 23:Parachute 3pos, 24:Auto Mission Reset,
    // 25:AttCon Feed Forward, 26:AttCon Accel Limits, 27:Retract Mount, 28:Relay On/Off, 34:Relay2 On/Off, 35:Relay3 On/Off, 36:Relay4 On/Off, 29:Landing Gear,
    // 30:Lost Copter Sound, 31:Motor Emergency Stop, 32:Motor Interlock, 33:Brake, 37:Throw, 38:ADSB-Avoidance, 39:PrecLoiter, 40:Object Avoidance,
...
// @Group: ATC_
// @Path:
// ../libraries/AC_AttitudeControl/AC_AttitudeControl.cpp,../libraries/AC_AttitudeControl/AC_AttitudeControl_Multi.cpp,../libraries/AC_AttitudeControl/AC_AttitudeControl_Heli.cpp
#if FRAME_CONFIG == HELI_FRAME
...
// @Path: ../libraries/AC_Avoidance/AC_Avoid.cpp
    ...
    // @Description: This enables terrain following for RTL and LAND flight modes. To use this option TERRAIN_ENABLE must be 1 and the GCS must  support sending
    // terrain data to the aircraft.  In RTL the RTL_ALT will be considered a height above the terrain.  In LAND mode the vehicle will slow to LAND_SPEED 10m
    // above terrain (instead of 10m above home).  This parameter does not affect AUTO and Guided which use a per-command flag to determine if the height is
...
const AP_Param::GroupInfo ParametersG2::var_info[] = {
    ...
    // @Description: Bitmask of developer options. The meanings of the bit fields in this parameter may vary at any time. Developers should check the source
    // code for current meaning
...
const AP_Param::ConversionInfo conversion_table[] = {
    ...
    {Parameters::k_param_arming_check_old, 3, AP_PARAM_INT8, "ARMING_CHECK"},
    // battery
...
void Copter::convert_pid_parameters(void) {
    ...
    const AP_Param::ConversionInfo throttle_conversion_info[] = {
        {Parameters::k_param_throttle_min, 0, AP_PARAM_FLOAT, "MOT_SPIN_MIN"}, {Parameters::k_param_throttle_mid, 0, AP_PARAM_FLOAT, "MOT_THST_HOVER"}};
    const AP_Param::ConversionInfo loiter_conversion_info[] = {{Parameters::k_param_wp_nav, 4, AP_PARAM_FLOAT, "LOIT_SPEED"},
    ...
    const uint8_t old_rc_keys[14] = {Parameters::k_param_rc_1_old,
        Parameters::k_param_rc_2_old,
        Parameters::k_param_rc_3_old,
        Parameters::k_param_rc_4_old,
        Parameters::k_param_rc_5_old,
        Parameters::k_param_rc_6_old,
        Parameters::k_param_rc_7_old,
        Parameters::k_param_rc_8_old,
        Parameters::k_param_rc_9_old,
        Parameters::k_param_rc_10_old,
        Parameters::k_param_rc_11_old,
        Parameters::k_param_rc_12_old,
        Parameters::k_param_rc_13_old,
        Parameters::k_param_rc_14_old};
